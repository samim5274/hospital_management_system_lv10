...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('expenses_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('category_id')->constrained('expenses_categories')->onDelete('restrict');
            $table->foreignId('sub_category_id')->constrained('expenses_sub_categories')->onDelete('restrict');
