            ...
            <div class="page-content bg-white p-4 rounded">
                <section class="row">                    
                    <div class="mb-0 shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <!-- FILTER FORM -->
                            <form action="{{ route('income.data.filter') }}" method="GET" class="card shadow-sm border-0">
                                <div class="card-body">
                        ...
                        <div class="card-body p-0">                            
                            <div class="table-responsive" style="max-height: 600px; overflow-y: auto;">
                                <table class="table table-hover align-middle mb-0" id="expensesTable">                                    
                                    ...
                                    <tbody>
                                        @forelse($inDetails as $key => $income)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('incomes-detail-view', $income->id) }}">
                                                        ...
                                                        <small class="text-muted">
                                                            {{ $income->category->name }} - {{ $income->subcategory->name }}
                                                        </small>
                                                    </a>
                                                </td>
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadSubcategories(categoryId, targetSelect) {
                ...
                if (categoryId) {
                    $.ajax({
                        url: "{{ route('get.in.subcategories', '') }}/" + categoryId, // Correct route
                        type: "GET",
                        dataType: "json",
