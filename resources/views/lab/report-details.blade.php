                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="card shadow-sm border-0 mt-4">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-2">
                                ...
                                <span class="badge bg-light text-primary">{{ count($patients) }} tests</span>
                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="{{ $patient->due > 0 ? 'background-color: #fff8e1;' : '' }}">
                                                <td>{{ $key + 1 }}</td>
                                                <td><a href="{{route('lab.test.report', $patient->reg)}}">{{ $patient->reg ?? '-' }}</a></td>
                                                <td><a href="{{route('lab.test.report', $patient->reg)}}">{{ $patient->name ?? '-' }}</a></td>
