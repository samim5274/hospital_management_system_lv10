...
<head>
    ...
    <title>Discharnge Patient - {{ $company->name ?? 'HMS' }}</title>
...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading mb-3">
                <h3 class="text-primary">Admit Patient - Discharge</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{url('/indoors/patient-discharge-list')}}">Patient List</a></li>
                ...
                <section class="row">
                    <div class="col-12">                        
                        ...
                        <div class="row g-3">
                            ...
                            <form action="{{route('discharge.patient', $billPrepared->reg)}}" method="POST">
                                @csrf
                                <!-- RIGHT COLUMN -->
                                <div class="col-xl-12 col-md-12">
                                    <div class="card shadow-sm border-0">
                                        <div class="card-header bg-primary text-center py-2 rounded-top">
                                            <h6 class="mb-0 text-white fw-semibold">Billing Summary Discharge</h6>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="card-body p-2">
                                                    <table class="table table-bordered table-sm mb-2">
                                                        <tbody>
                                                            ...
                                                            <tr><td>Cabin Fee</td><td><input type="number" min="0" name="cabin_fee" class="form-control form-control-sm calc-field" value="{{$billPrepared->cabin_fee ?? '0'}}" readonly></td></tr>
                                                            <tr><td>Doctor’s Fee</td><td><input type="number" min="0" name="doctor_fee" class="form-control form-control-sm calc-field" value="{{$billPrepared->doctor_fee ?? '0'}}" readonly></td></tr>
                                                            <tr><td>Service Charge</td><td><input type="number" min="0" name="service_charge" class="form-control form-control-sm calc-field" value="{{$billPrepared->service_charge ?? '0'}}" readonly></td></tr>
                                                            <tr><td>O.T Medicine</td><td><input type="number" min="0" name="ot_medicine" class="form-control form-control-sm calc-field" value="{{$billPrepared->ot_medicine ?? '0'}}" readonly></td></tr>
                                                            <tr><td>Oral Medicine</td><td><input type="number" min="0" name="oral_medicine" class="form-control form-control-sm calc-field" value="{{$billPrepared->oral_medicine ?? '0'}}" readonly></td></tr>
                                                            <tr><td>Others</td><td><input type="number" min="0" name="others" class="form-control form-control-sm calc-field" value="{{$billPrepared->others ?? '0'}}" readonly></td></tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body p-2">
                                                    <table class="table table-bordered table-sm">
                                                        <tbody>
                                                            ...
                                                            <tr><td>Paid</td><td><input type="number" min="0" name="paid_amount" class="form-control form-control-sm text-end text-success fw-bold" value="{{$billPrepared->paid_amount}}" readonly></td></tr>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <div class="col-12 d-flex justify-content-between">
                                                        @if($patient->status != 2)
                                                        <input type="submit" class="btn btn-outline-success w-100" value="Discharge Patient" onclick="return confirm('Are you sure you want to discharge this patient?');">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const dischargeButton = document.querySelector('input[value="Discharge Patient"]');
            ...
            function calculateTotals() {
                ...
                // Set max discount = total cost
                discountInput.max = totalCost.toFixed(2);
