...
<head>
    ...
    <style>
        ...
        /* Half-page container centered */
        .invoice-container {
            width: 50%; /* Half of landscape width */
            min-width: 105mm; /* minimum half-page width */
        ...
        h4 { font-size: 13px; margin: 3px 0; }
        p { margin: 1px 0; }

        /* Header */
        .invoice-header { padding-bottom: 5px; margin-bottom: 5px; }
        ...
        .invoice-subheader table { width: 100%; font-size: 11px; line-height: 1.4; }
        ...
        table th, table td { border: 1px dashed #000; padding: 3px 5px; }
        table th { border: 1px dashed #000; background: #f7f7f7; text-align: center; }
        table td:last-child { text-align: right; }

        /* Totals */
        .totals { width: 100%; margin-top: 6px; font-size: 11px; }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: left;">{{ $test->test->testName ?? '' }}</td>
