    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3><i class="bi bi-clipboard2-pulse me-1"></i> Date wise Diagnostic Test Sale Report</h3>
            </div>            
                ...
                <div class="card mt-3 shadow-sm">
                    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="mb-0 fw-semibold text-primary">
                            <i class="bi bi-receipt"></i> Test Sale Report
                        </h6>

                        <!-- Right button -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#filterModal">
                            <i class="bi bi-funnel"></i> Filter Test Sale
                        </button>
                        ...
                        <div class="modal fade" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <form method="GET" action="{{ route('filter-test-sale') }}">
                                        @php
                                            $today = date('Y-m-d');
                                        @endphp
                                        ...
                                        <div class="modal-header bg-primary">
                                            <h5 class="modal-title fw-semibold text-white" id="filterModalLabel">
                                                <i class="bi bi-funnel fs-3"></i> Report Filter
                                            </h5>
